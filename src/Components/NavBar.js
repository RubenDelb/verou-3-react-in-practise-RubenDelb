            ...
            <NavLink to="/" className="flex items-center">
				...
				<div className="w-full block w-auto" id="mobile-menu">
					<ul className="flex flex-row mt-4 sm:space-x-8 mt-0 text-sm font-medium">
						<li>
							<NavLink style={activeLinkStyle} to="/" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 hover:bg-transparent border-0 hover:text-blue-700 p-0 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:hover:bg-transparent dark:border-gray-700">Current</NavLink>
						</li>
						<li>
							<NavLink style={activeLinkStyle} to="/hourly" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 hover:bg-transparent border-0 hover:text-blue-700 p-0 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:hover:bg-transparent dark:border-gray-700">Hourly</NavLink>
						</li>
						<li>
							<NavLink style={activeLinkStyle} to="/daily" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 hover:bg-transparent border-0 hover:text-blue-700 p-0 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:hover:bg-transparent dark:border-gray-700">Daily</NavLink>
						</li>
					</ul>
				</div>
        </div>
